...
public:
    ...
    float elf(glm::vec2 pos);
    float bat(glm::vec2 pos);
    float trebleClef(glm::vec2 pos);
...
public:
    ...
    float intersect_function_R0(float f1, float f2, glm::vec2 gradf1, glm::vec2 gradf2, float n);
    float union_function_R0(float f1, float f2, glm::vec2 gradf1, glm::vec2 gradf2, float n);
